...
let profileInfo = {
    ...
    favoriteFoods: ['Pizza', 'Burguer', 'Lasagna'],
    hobbies: ['Art Toys','COD','Bike'],
    placeLived: []
};

// Step 7: Inside of the empty array above, add a new object with two properties: place and length and values of an empty string
profileInfo.placeLived = [
    {
        place: 'Puerto la Cruz, AN',
        length: '2 years'
    },
    {
        place: 'Maracaibo, ZU',
...
document.querySelector('#photo').setAttribute('src', profileInfo.photo);
document.querySelector('#photo').setAttribute('alt', profileInfo.name);

profileInfo.favoriteFoods.forEach((food) => {
...
profileInfo.hobbies.forEach((hobby) => {
...
profileInfo.placeLived.forEach((placeLived) => {
